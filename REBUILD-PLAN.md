...
- **Course data/mapping** ← `gd-course-geometry-resolver`, `gd-course-library-pin-lock` (split library vs UI), `gd-course-play-pipeline`, `gd-course-mapping-debug`, `gd-course-visual-engine`, `gd-captured-surface-model/sync`, `gd-captured-hole-frame-camera-v19`, `gd-hole-frame-guide-contract-v20`, `gd-auto-map-handoff-quarantine-v1`
