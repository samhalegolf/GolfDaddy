...
assert(index.includes("gd-gps-play-runtime-owner-v1.js?v=gps-location-lifecycle-20260719"), "GPS runtime cache-bust ships the pin prompt wrapper guard and location lifecycle owner");
