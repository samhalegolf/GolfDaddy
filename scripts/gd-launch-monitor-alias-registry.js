(function () {
  ...
  var entries = [
    ...
    },
    {
      ...
      unit: 'm',
      confidence: 0.72,
      aliases: ['carry', 'total carry', 'carry distance', 'carry dist', 'distance', 'carrydistance']
    },
    {
      key: 'total',
      label: 'Total',
    ...
    },
    {
      ...
      unit: 'm',
      confidence: 0.7,
      aliases: ['offline', 'off line', 'off', 'side', 'side carry', 'side total', 'lateral', 'dispersion']
    },
    {
      key: 'clubSpeed',
      label: 'ClubSpeed',
    ...
    },
    {
      key: 'toPin',
      label: 'To Pin',
      aliases: ['to pin', 'topin', 'dist to pin', 'distance to pin', 'disttopin']
    },
    {
      key: 'lastData',
      label: 'Last Data',
