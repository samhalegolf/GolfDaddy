  ...
  var REGISTRY = [
    ...
    { id: "gps-bubble-projection", label: "Bubble Projection", parent: "gps-shot-planning",
      ...
      code: [
        ...
        { role: "Fresh-app render/consumption of the mirror", path: "app/js/painter.js" },
